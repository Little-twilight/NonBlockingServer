...
public class SocketChannelDaemon {
    ...
    public void enable(InetSocketAddress address, long timeoutMilliseconds, int reconnect) {
        synchronized (mLock) {
            ...
            mIsEnabled = true;
            Logger.i(TAG, uniformLogFormat("Socket daemon enabled: %s"));
    ...
    public void disable() {
        synchronized (mLock) {
            ...
            try {
                ...
                Logger.i(TAG, uniformLogFormat("Socket daemon disabled"));
                mIsEnabled = false;
            }
        }
    }
    ...
    private void checkSocketStatus() {
        ...
        synchronized (mLock) {
            ...
            if (mConnectTrailRemains > 0) {
                ...
                Logger.i(TAG, uniformLogFormat(String.format("%s, %s", majorMsg, timeoutTag)));
